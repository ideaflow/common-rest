 ...
 */
package com.bancvue.rest.client.crud;

import com.bancvue.rest.api.ApiEntity;
import com.bancvue.rest.client.ClientRequestFactory;
import com.bancvue.rest.client.request.Header;
import com.bancvue.rest.client.response.ResponseInspector;
...
public abstract class CrudClient<API_TYPE, CLIENT_TYPE extends CrudClient> {
	...
	public CrudClient(String baseUrl, String path, Class<API_TYPE> type) {
		this(new ClientRequestFactory().register(ObjectMapperContextResolver.class), baseUrl, path, type);
	}

	public CrudClient(ClientRequestFactory clientRequestFactory, String baseUrl, String path, Class<API_TYPE> type) {
