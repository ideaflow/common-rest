...
public class BasicClientRequestExecutor implements ClientRequestExecutor {

	private WebTarget baseResource;
	private WebApplicationExceptionFactory exceptionFactory;

	public BasicClientRequestExecutor(WebTarget baseResource) {
		this(baseResource, new DefaultWebApplicationExceptionFactory());
	}

	public BasicClientRequestExecutor(WebTarget baseResource, WebApplicationExceptionFactory exceptionFactory) {
