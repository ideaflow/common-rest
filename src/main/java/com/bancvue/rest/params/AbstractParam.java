...
public abstract class AbstractParam<T> {
	...
	/**
	 * Given a string representation which was unable to be parsed, produce a {@link Response.Status} for the
	 * {@link Response} to be sent to the client.
	 *
	 * @return the HTTP {@link Response.Status} of the error message
	 */
